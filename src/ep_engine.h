...
public:
    ...
    ENGINE_ERROR_CODE uprStreamStart(const void* cookie,
                                     uint32_t opaque,
                                     uint16_t vbucket);
    ENGINE_ERROR_CODE uprStreamEnd(const void* cookie,
                                   ...
                                   uint16_t vbucket,
                                   uint32_t flags);
    ENGINE_ERROR_CODE uprSnapshotStart(const void* cookie,
                                       uint32_t opaque,
                                       uint16_t vbucket);
    ENGINE_ERROR_CODE uprSnapshotEnd(const void* cookie,
                                     uint32_t opaque,
                                     uint16_t vbucket);
